 ...
 * @version		$Id: class.ilTestOutputGUI.php 39193 2013-01-11 11:39:09Z mjansen $
 * 
 * @ingroup ModulesTest
 * 
...
*/
	function outTestPage()
	{
		...
		// change seb screenshot begin		
		$this->tpl->setCurrentBlock("seb_screenshot");
		...
		$this->tpl->setVariable("QUEST_ID", $this->object->getTestSequence()->getQuestionForSequence($this->sequence));
		// change seb screenshot end
